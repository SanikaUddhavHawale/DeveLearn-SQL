...
('Noida Sales','5 Sector Road','Noida','Uttar Pradesh','India','201301','North','+91-12-40001009','noida.sales@pepsico.co.in'),
('Surat Depot','14 Trade Street','Surat','Gujarat','India','395004','West','40001010','surat.depot@pepsico.co.in'),
('Lucknow Office','2 Corporate Tower','Lucknow','Uttar Pradesh','India','226001','North','40001011','lucknow.office@pepsico.co.in'),
('Nagpur Distribution','18 Central Logistics','Nagpur','Maharashtra','India','440001','Central','40001012','nagpur.dist@pepsico.co.in'),
('Coimbatore Plant','66 Textile Road','Coimbatore','Tamil Nadu','India','641018','South','40001013','coimbatore.plant@pepsico.co.in'),
('Vishakhapatnam Depot','11 Harbor Road','Visakhapatnam','Andhra Pradesh','India','530017','South','40001014','vizag.depot@pepsico.co.in'),
('Indore Office','27 Industrial Estate','Indore','Madhya Pradesh','India','452010','Central','40001015','indore.office@pepsico.co.in'),
('Bhopal Warehouse','3 Logistic Ring','Bhopal','Madhya Pradesh','India','462001','Central','40001016','bhopal.wh@pepsico.co.in'),
('Jaipur Depot','50 Pink City Road','Jaipur','Rajasthan','India','302001','North','40001017','jaipur.depot@pepsico.co.in'),
('Bhubaneswar Office','8 Odisha Plaza','Bhubaneswar','Odisha','India','751001','East','40001018','bhubaneswar.office@pepsico.co.in'),
('Ernakulam Plant','40 Backwater Ave','Kochi','Kerala','India','682016','South','40001019','kochi.plant@pepsico.co.in'),
('Goa Distribution','12 Seaside Road','Panaji','Goa','India','403001','West','40001020','goa.dist@pepsico.co.in');
...
-- ---------------------------
INSERT INTO Categories (CategoryName, Description, CreatedDate, TaxRate, HSNCode, GSTApplicable, ParentCategoryID) VALUES
('Carbonated','Carbonated soft drinks - cola and flavored','2023-01-10 09:00:00',18.00,'2202',TRUE,NULL),
('Juices & Nectars','Fruit juices and nectar beverages','2023-01-12 09:00:00',12.00,'2009',TRUE,NULL),
('Bottled Water','Packaged drinking water','2023-01-15 09:00:00',18.00,'2201',TRUE,NULL),
('Ready-to-Drink Tea/Coffee','RTD tea and coffee beverages','2023-01-20 09:00:00',18.00,'2101',TRUE,NULL),
('Chips & Crisps','Potato chips and extruded snacks','2023-02-01 09:00:00',18.00,'2106',TRUE,NULL),
('Nuts & Snacks','Roasted nuts and healthy snacks','2023-02-05 09:00:00',18.00,'2008',TRUE,NULL),
('Dips & Sauces','Condiments, sauces and dips','2023-02-10 09:00:00',18.00,'2103',TRUE,NULL),
('Breakfast Cereals','Cereal and grain-based breakfast products','2023-02-12 09:00:00',18.00,'1904',TRUE,NULL),
('Confectionery','Candies, chocolates and gums','2023-02-14 09:00:00',18.00,'1704',TRUE,NULL),
('Health Drinks','Nutritious powdered drinks and supplements','2023-02-16 09:00:00',12.00,'2102',TRUE,NULL),
('Ready Meals','Packaged ready-to-eat meals','2023-03-01 09:00:00',18.00,'1602','TRUE',NULL),
('Sauces & Dressings','Salad dressings and cooking sauces','2023-03-05 09:00:00',18.00,'2103',TRUE,NULL),
('Pet Beverages','Non-alcoholic specialty beverages','2023-03-10 09:00:00',18.00,'2202',TRUE,NULL),
('Ketchup','Tomato ketchup and related products','2023-03-15 09:00:00',18.00,'2103',TRUE,NULL),
('Snack Bars','Energy and protein bars','2023-03-20 09:00:00',18.00,'1904',TRUE,NULL),
('Ice Cream & Frozen Desserts','Frozen desserts and ice creams','2023-03-22 09:00:00',18.00,'2105',TRUE,NULL);
...
-- ==============================================================
-- Batch 2: Products, Customers, Orders, OrderDetails, Payments
-- ==============================================================
...
-- ==============================================================
-- Batch 3: Inventory, Warehouses, RawMaterials, ProductionBatch, QualityCheck
-- ==============================================================
...
-- ==============================================================
-- Batch 4: Distributors, Retailers, Shipments, Transport, Machines
-- ==============================================================
